...
def analyze_sentiments():
    ...
    try:
        ...
        result_label2=tk.Label(app,text=f"Negative Sentiment: {sentiment_counts.get('Negative', 0):.2f}%", bg="lightblue").place(x=138, y=410)
        result_label3=tk.Label(app,text=f"Neutral Sentiment: {sentiment_counts.get('Neutral', 0):.2f}%", bg="lightblue").place(x=138, y=435)
